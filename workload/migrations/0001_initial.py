    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authority', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='limitations', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Location',
        ...
        migrations.AddField(
            ...
            name='location',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='limitation_location', to='workload.Location'),
        ),
        migrations.AddField(
